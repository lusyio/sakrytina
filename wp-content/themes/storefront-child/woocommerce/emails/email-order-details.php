    ...
    <table class="td" cellspacing="0" cellpadding="6"
        ...
        <tr>
            <th class="td" scope="row" colspan="2"
                style="text-align:<?php echo esc_attr($text_align); ?>;"><?php esc_html_e('Книга', 'woocommerce'); ?></th>
            <th class="td" scope="row" colspan="2"
        ...
        if ($item_totals) {
            ...
            foreach ($item_totals as $total) {
                ...
                <tr>
                    ...
                    <td class="td"
                        style="text-align:<?php echo esc_attr($text_align); ?>; <?php echo (1 === $i) ? 'border-top-width: 4px;' : ''; ?>"><?= wp_kses_post($total['value']) === 'Оплата при доставке' ? 'PayPal' : wp_kses_post($total['value']) ?></td>
                </tr>
                <?php
            }
        }
