            ...
            <div class="card-payment-info__body">
                <div id="ebookTarget" class="card-payment-info__content">
                    <div class="d-flex justify-content-between">
                        <p class="card-payment-info__price">139</p>
                        <button class="btn btn-primary">Добавить в корзину</button>
                    </div>
                    <hr>
                    <p>Как купить? Добавьте книгу в корзину и оформите заказ. Оплата осуществляется с помощью банковской
                ...
                <div id="audiobookTarget" class="card-payment-info__content">
                    <div class="d-flex justify-content-between">
                        <p class="card-payment-info__price">247</p>
                        <button class="btn btn-primary">Добавить в корзину</button>
                    </div>
                    <hr>
                    <p>Как купить? Добавьте книгу в корзину и оформите заказ. Оплата осуществляется с помощью банковской
