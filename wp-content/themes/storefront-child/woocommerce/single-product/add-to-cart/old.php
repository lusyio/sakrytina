...
// проверяем, доступна ли электорнная версия для продажи на сайте?
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-12 pr-unset pr-lg-0 mb-payment">
                <div data-id="elektronnaya-kniga"
                     class="card-payment <?= (in_array('elektronnaya-kniga', $arr)) ? 'active' : 'disabled' ?>">
            ...
            <div class="col-lg-4 col-12 pr-unset pr-lg-0 mb-payment">
                <div data-id="audiokniga"
                     class="card-payment <?= (in_array('elektronnaya-kniga', $arr)) ? '' : 'active' ?> <?= (in_array('audiokniga', $arr)) ? '' : 'disabled' ?>">
                    <div class="card-payment__body">
                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
